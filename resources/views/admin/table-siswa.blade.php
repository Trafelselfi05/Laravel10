                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('delete-siswa', $post->id)}}" method="POST">
                                                    @csrf
                                                    <button type="button" class="btn btn-light btn_update"
                                                        data-bs-toggle="modal"
                                                        data-bs-target="#edit{{$post->id}}">✎</button>
                                                    @method('DELETE')
                                                    <button
                                                        onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"
                                                        class="btn btn-light" type="submit">❌</button>
                                                </form>
                                            </td>
                                        </tr>
                                        <div id="edit{{$post->id}}" class="modal fade" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{ route('update-siswa', $post->id) }}" method="post">
                                                            @csrf
                                                            @method('PUT')
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group">
                                                                    <div class="mb-3">
                                                                        <label for="formNama" class="form-label">Nama
                                                                            :</label>
                                                                        <input value="{{ $post->nama }}" type="text"
                                                                            class="form-control" name="nama" id="formNama">
                                                                    </div>
                                                                </div>

                                                                <div class="form-group">
                                                                    <div class="mb-3">
                                                                        <label for="formAlamat" class="form-label">Alamat
                                                                            :</label>
                                                                        <input value="{{ $post->alamat }}" type="text"
                                                                            class="form-control" name="alamat"
                                                                            id="formAlamat" placeholder="" />
                                                                    </div>
                                                                </div>

                                                                <div class="form-group">
                                                                    <div class="mb-3">
                                                                        <label for="formJenisKelamin"
                                                                            class="form-label">Jenis Kelamin :</label>
                                                                        <select class="form-select" id="formJenisKelamin"
                                                                            name="jenis_kelamin"
                                                                            aria-label="Floating label select example">
                                                                            <option @if ($post->jenis_kelamin === 'Male')
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="mb-3">
                                                                        <label for="formUmur" class="form-label">Umur :
                                                                        </label>
                                                                        <input value="{{ $post->umur }}" type="number"
                                                                            class="form-control" id="formUmur"
                                                                            name="umur" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="mb-3">
                                                                        <label for="formTanggalLahir"
                                                                            class="form-label">Tanggal Lahir : </label>
                                                                        <input value="{{ $post->tanggal_lahir }}"
                                                                            type="text" class="form-control"
                                                                            id="formTanggalLahir" name="tanggal_lahir" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <!-- end row -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="formJenisKelamin" name="jenis_kelamin"
                                                aria-label="Floating label select example">
                                    ...
                                    <div class="form-group">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="formTanggalLahir"
                                                name="tanggal_lahir" />
                                        </div>
                                    </div>
                                </div>
